function [model] = vol3dd(varargin)
...
%
% vol3d(...,'xdata',[xmin xmax]) Limits for data scaling (use also for ydata and zdata).
%
...
% copyright holder.
% Further improvements by Alessandro Savoia, 2010.

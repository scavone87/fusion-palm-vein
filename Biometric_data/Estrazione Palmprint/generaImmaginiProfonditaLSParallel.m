...
for fileIdx = 1:length(matFiles)
    ...
    parfor i = 2:7
        ...
        [surf_filt, FFF] = surface_detection_modified(M, tresh, filter_siz, depth, Z);
        temp_surf_filt(:,:,i) = surf_filt; % Array temporaneo
        temp_FFF(:,:,i) = FFF; % Array temporaneo
    end

    % Assegna i risultati temporanei a surf_filt e FFF dopo il ciclo
    surf_filt = temp_surf_filt;
    FFF = temp_FFF;
